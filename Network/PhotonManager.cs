...
namespace CivilizameMP.Network
{
    public class PhotonManager : MonoBehaviour, IConnectionCallbacks, IMatchmakingCallbacks, IInRoomCallbacks, IOnEventCallback, ILobbyCallbacks
    {
        ...
        public event Action<bool> OnRemoteReadyEvent;
        ...
        void IConnectionCallbacks.OnDisconnected(DisconnectCause cause)
        {
            ...
            CivilizameMPPlugin.Log.LogWarning($"[Photon] ⚠️ Desconectado: {cause}");
            OnDisconnectedEvent?.Invoke();
        }
        ...
        void IMatchmakingCallbacks.OnJoinedRoom()
        {
            ...
            bool isMaster = _client.LocalPlayer.IsMasterClient;
            ...
            CivilizameMPPlugin.Log.LogInfo($"[Photon] Master: {isMaster}, Jugadores: {_client.CurrentRoom?.PlayerCount}/{_client.CurrentRoom?.MaxPlayers}");
        ...
        void IInRoomCallbacks.OnPlayerEnteredRoom(Player newPlayer)
        {
            ...
            MPStateManager.Instance.RemotePlayerName = newPlayer.NickName;
        ...
        void IMatchmakingCallbacks.OnJoinRandomFailed(short returnCode, string message)
        {
            ...
            MPStateManager.Instance.SetState(MPGameState.Disconnected);
            CivilizameMPPlugin.Log.LogWarning($"[Photon] ⚠️ Unirse aleatorio falló: {message} (code {returnCode})");
        }
        ...
        void IOnEventCallback.OnEvent(EventData photonEvent)
        {
            ...
            switch (photonEvent.Code)
            {
                ...
                case CONFIG_EVENT:
                    ...
                    {
                        CivilizameMPPlugin.Log.LogInfo($"[Photon] ⚙️ Config recibida: {configData}");
                ...
                case READY_EVENT:
                    ...
                    {
                        CivilizameMPPlugin.Log.LogInfo($"[Photon] ✅ Ready recibido: {ready}");
                        OnRemoteReadyEvent?.Invoke(ready);
                    }
                    break;
            }
        }
